...
import es.uca.iw.uj2016.web.PerfilController;
...
privileged aspect PerfilController_Roo_Controller {
    ...
    public String PerfilController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String PerfilController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Perfil.findPerfil(id));
        return "perfils/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String PerfilController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
