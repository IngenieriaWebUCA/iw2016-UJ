...
import es.uca.iw.uj2016.web.CiudadController;
...
privileged aspect CiudadController_Roo_Controller {
    ...
    public String CiudadController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String CiudadController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Ciudad.findCiudad(id));
        return "ciudads/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String CiudadController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
