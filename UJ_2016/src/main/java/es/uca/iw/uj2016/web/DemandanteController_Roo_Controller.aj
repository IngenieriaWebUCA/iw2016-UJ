...
privileged aspect DemandanteController_Roo_Controller {
    ...
    public String DemandanteController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String DemandanteController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Demandante.findDemandante(id));
        return "demandantes/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String DemandanteController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
