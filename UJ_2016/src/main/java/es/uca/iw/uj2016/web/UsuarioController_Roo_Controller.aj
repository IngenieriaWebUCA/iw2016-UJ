...
import es.uca.iw.uj2016.web.UsuarioController;
...
privileged aspect UsuarioController_Roo_Controller {
    ...
    public String UsuarioController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String UsuarioController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Usuario.findUsuario(id));
        return "usuarios/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String UsuarioController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
